    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-login">Login a user</a>
                            </li>
                                ...
                                <a href="#auth-POSTapi-logout">Logout a user</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="items">
                    <a href="#items">Items</a>
                                ...
                                <a href="#items-GETapi-items-top">Get top items</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="players">
                    <a href="#players">Players</a>
                                ...
                                <a href="#players-GETapi-players">Get all players</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="players-GETapi-players--player_id--stats">
                                <a href="#players-GETapi-players--player_id--stats">Get player stats</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="players-GETapi-leaderboard">
                                <a href="#players-GETapi-leaderboard">Get leaderboard</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-POSTapi-login">Login a user</h2>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization"                data-endpoint="GETapi-user"
               value="Bearer <token>"
               data-component="header">
    <br>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-POSTapi-logout">Logout a user</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="items">Items</h1>
                                ...
                                <h2 id="items-GETapi-items-top">Get top items</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/items/top" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<form id="form-GETapi-items-top" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-items-top');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-items-top"
                    onclick="cancelTryOut('GETapi-items-top');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="players">Players</h1>
                                ...
                                <h2 id="players-GETapi-players">Get all players</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="players-GETapi-players--player_id--stats">Get player stats</h2>
...
<span id="example-requests-GETapi-players--player_id--stats">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/players/1/stats" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/players/1/stats"
);
...
<span id="example-responses-GETapi-players--player_id--stats">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-players--player_id--stats" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-players--player_id--stats"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-players--player_id--stats"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-players--player_id--stats" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-players--player_id--stats">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-players--player_id--stats" data-method="GET"
      data-path="api/players/{player_id}/stats"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-players--player_id--stats', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-players--player_id--stats"
                    onclick="tryItOut('GETapi-players--player_id--stats');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-players--player_id--stats"
                    onclick="cancelTryOut('GETapi-players--player_id--stats');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-players--player_id--stats"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/players/{player_id}/stats</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-players--player_id--stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-players--player_id--stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="player_id"                data-endpoint="GETapi-players--player_id--stats"
               value="1"
               data-component="url">
    <br>
<p>The ID of the player. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="players-GETapi-leaderboard">Get leaderboard</h2>
